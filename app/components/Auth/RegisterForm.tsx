        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex items-center">
            ...
            <label htmlFor="terms" className="ml-2 block text-sm text-gray-700">
              I agree to the <a href="#" className="text-indigo-500 hover:text-indigo-700">Terms of Service</a> and <a href="#" className="text-indigo-500 hover:text-indigo-700">Privacy Policy</a>
            </label>
          </div>
